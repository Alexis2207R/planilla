...
--
-- Servidor: localhost
-- Tiempo de generación: 16-12-2022 a las 04:43:15
...
INSERT INTO `pagos` (`id_pago`, `id_personal`, `id_planilla`, `id_mes`, `fecha_creacion`, `estado_pago`) VALUES
(3, 5, 16, 1, '2022-12-12 00:36:20', 1),
(4, 5, 16, 2, '2022-12-12 00:36:34', 1),
(5, 5, 16, 3, '2022-12-12 00:36:42', 1),
(6, 5, 16, 4, '2022-12-12 00:36:53', 1),
(7, 5, 16, 5, '2022-12-12 00:37:22', 1),
(8, 5, 18, 1, '2022-12-12 00:38:30', 2),
(9, 5, 18, 2, '2022-12-12 00:38:45', 2),
(10, 5, 18, 6, '2022-12-12 00:41:15', 1),
(11, 5, 17, 2, '2022-12-15 19:04:01', 1),
(12, 5, 17, 2, '2022-12-15 20:50:07', 1),
(13, 5, 17, 6, '2022-12-15 21:13:13', 1),
(14, 5, 17, 6, '2022-12-15 21:13:53', 1),
(15, 5, 18, 5, '2022-12-15 21:19:17', 1);
...
INSERT INTO `planilla` (`id_planilla`, `id_tipo_planilla`, `id_year`, `numero_planilla`, `total_ingreso`, `total_egreso`, `total_neto`, `fecha_creacion_planilla`, `estado_planilla`) VALUES
(9, 2, 6, '0875', '54.000', '45.000', '9.000', NULL, 0),
(10, 4, 7, '6234', NULL, NULL, NULL, NULL, 0),
(11, 2, 6, '6342', NULL, NULL, NULL, NULL, 0),
(12, 5, 7, '6135', NULL, NULL, NULL, NULL, 0),
(13, 5, 6, '1564', NULL, NULL, NULL, NULL, 0),
(14, 5, 7, '8731', '150.000', '23.000', '127.000', NULL, 0),
(15, 5, 7, '45345', '104.000', '45.000', '59.000', '2022-12-11 08:30:28', 0),
(16, 2, 7, '123', '591.000', '310.000', '281.000', '2022-12-12 00:34:53', 1),
(17, 2, 6, '421', '461.000', '140.000', '321.000', '2022-12-12 00:35:48', 1),
(18, 5, 7, '654', '782.000', '310.000', '472.000', '2022-12-12 00:38:16', 1);
...
--
-- Volcado de datos para la tabla `planilla_bonificacion`
--

INSERT INTO `planilla_bonificacion` (`id_planilla_bonificacion`, `id_planilla`, `id_bonificacion`, `estado_planilla_bonificacion`) VALUES
(12, 16, 13, 1),
(13, 16, 14, 1),
(14, 16, 15, 1),
(15, 17, 16, 1),
...
--
-- Volcado de datos para la tabla `planilla_descuento`
--

INSERT INTO `planilla_descuento` (`id_planilla_descuento`, `id_planilla`, `id_descuento`, `estado_planilla_descuento`) VALUES
(23, 16, 8, 1),
(24, 16, 9, 1),
(25, 17, 12, 1),
(26, 17, 13, 1),
...
--
ALTER TABLE `pago_bonificacion`
  MODIFY `id_pago_bonificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `pago_descuento`
--
ALTER TABLE `pago_descuento`
  MODIFY `id_pago_descuento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `planilla`
  MODIFY `id_planilla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
