...
--
-- Servidor: localhost
-- Tiempo de generación: 11-12-2022 a las 00:05:06
...
INSERT INTO `planilla` (`id_planilla`, `id_tipo_planilla`, `id_year`, `numero_planilla`, `total_ingreso`, `total_egreso`, `total_neto`, `estado_planilla`) VALUES
(1, 5, 1, '01765', NULL, NULL, NULL, 1);
...
CREATE TABLE `planilla_bonificacion` (
  ...
  `id_planilla` int(11) NOT NULL,
  `id_bonificacion` int(11) NOT NULL,
  `estado_planilla_bonificacion` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `modulo`
  MODIFY `id_modulo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `planilla_bonificacion`
  MODIFY `id_planilla_bonificacion` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `planilla_descuento`
--
ALTER TABLE `planilla_descuento`
  MODIFY `id_planilla_descuento` int(11) NOT NULL AUTO_INCREMENT;
