...
--
-- Servidor: localhost
-- Tiempo de generación: 29-12-2022 a las 01:24:27
...
(19, 5, 20, 1, '358.000', '96.000', '262.000', '2022-12-23 10:49:46', 1),
(20, 5, 20, 2, '557.000', '198.000', '359.000', '2022-12-23 10:50:29', 1),
(21, 5, 20, 3, '663.000', '100.000', '563.000', '2022-12-23 10:51:17', 1),
(22, 5, 21, 1, '954.000', '234.000', '720.000', '2022-12-23 10:51:44', 1);
...
(5, 4, 'HERLYN CARLOS', 'PAZ VASQUEZ', '71700578', 'M', 'SAN MARTIN', 'RIOJA', 'PARDO MIGUEL', 'JR. FRANCISCO PIZARRO 968', '7742345543', 2, 2, 31, '30.0', NULL, '2022-12-21 23:46:30', 1),
(6, 5, 'ROSA ANDREA', 'HERNANDEZ MARTINEZ', '', 'F', NULL, NULL, NULL, NULL, '04523432348923', 4, 8, 31, '30.0', '2022-12-21 23:29:20', '2022-12-21 23:30:02', 1);
...
(20, 2, 6, '02019', '2022-12-23 10:48:41', 1),
(21, 4, 7, '02020', '2022-12-23 10:49:01', 1),
(22, 5, 8, '02021', '2022-12-23 10:49:15', 1);
...
--
ALTER TABLE `ano`
  MODIFY `id_year` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `pago_bonificacion`
  MODIFY `id_pago_bonificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `pago_descuento`
--
ALTER TABLE `pago_descuento`
  MODIFY `id_pago_descuento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `planilla`
  MODIFY `id_planilla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
