...
class Controller
{
    ...
    public function ViewData($view = null, $data){
    ...
    public function crypCode($param){
        $key_crip = '$2a$07$asxx54ahjppf45sd87a5a4dDDGsystemdev$';
        $crypt_param = crypt($param, $key_crip);
        return $crypt_param;
    }
